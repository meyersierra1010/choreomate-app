            ...
            {auth.user && (
              <NavDropdown id="dropdown" title="Account" alignRight={true}>
                <Link href="/dashboard" passHref={true}>
                  <NavDropdown.Item active={false}>My Projects</NavDropdown.Item>
                </Link>
                <Link href="/videos" passHref={true}>
                  <NavDropdown.Item active={false}>My Videos</NavDropdown.Item>
                </Link>
                <Link href="/musics" passHref={true}>
                  <NavDropdown.Item active={false}>My Musics</NavDropdown.Item>
                </Link>
                <Dropdown.Divider />
