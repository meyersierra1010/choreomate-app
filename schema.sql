...
create policy "Can read projects they own" on public.projects for select using ( auth.uid() = "owner" );
create policy "Can insert projects they own" on public.projects for insert with check ( auth.uid() = "owner" );
create policy "Can update projects they own" on public.projects for update using ( auth.uid() = "owner" );
create policy "Can delete projects they own" on public.projects for delete using ( auth.uid() = "owner" );
...
create policy "Can read videos they own" on public.videos for select using ( auth.uid() = "owner" );
create policy "Can insert videos they own" on public.videos for insert with check ( auth.uid() = "owner" );
create policy "Can update videos they own" on public.videos for update using ( auth.uid() = "owner" );
create policy "Can delete videos they own" on public.videos for delete using ( auth.uid() = "owner" );
